import HasDetails from '@/components/help/postpartum/has-details'
    ...
    return (
        <div className="flex flex-1 flex-col w-5/6">
            <Header
                ...
                subtitle="It is inevitable that some of you will be scammed. Therefore we have create a guide below to help you with the vulnerable recovery process."
            />
