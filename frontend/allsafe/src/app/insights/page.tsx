    ...
    return (
        <div className="flex flex-col w-full p-6 gap-y-12 max-w-full">
            ...
            <section
                ...
                className="flex flex-col flex-wrap w-full min-h-screen justify-around items-center max-w-full"
            >
            ...
            <section
                ...
                className="flex flex-col min-h-screen items-center max-w-full gap-y-16"
            >
                <TypographyH2 className="border-0">
                    Does the money lost follow a similar pattern as the number
                    of reports?
                </TypographyH2>
                <div className="flex flex-col justify-around sm:flex-row w-full">
                    <div
